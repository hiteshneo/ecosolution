				...
				'<div class="row form-row">' +
					...
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="text" class="form-control" name="completeyear[]" id="completeyear">' +
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
				...
				'<div class="row form-row">' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="text" class="form-control" name="experiencePlace[]" id="experiencePlace">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							'<label>Total Experience</label>' +
							'<input type="text" class="form-control" name="totalExp[]" id="totalExp">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
