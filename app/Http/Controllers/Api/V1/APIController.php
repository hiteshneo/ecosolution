...
class APIController extends Controller
{
    ...
    public function userSetHidden($user){
        $user->setHidden(['uuid','avatar_type','password_changed_at','active','confirmation_code','confirmed','timezone', 'last_login_at', 'last_login_ip', 'to_be_logged_out', 'created_by', 'updated_by', 'is_term_accept', 'remember_token', 'device_token', 'avatar_location', 'password', 'deleted_at']);
    }
